...
// Map 
let map = L.map('map', {scrollWheelZoom: false}).setView([57.057602517982154, 9.919072478631133], 14);
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoidGFtYXNob2xsb3MiLCJhIjoiY2w0MDFvdnh2MTlzbjNicWdndTJiMHRveiJ9.hjxH4OdkKlUBrdUPV3PjGw', {
...
// Selecting the applicable a tags
    ...
    for(let i = 0; i < aS.length; i++) {
     ...
     const flatNavItem = navItem.flat().filter(item => item.classList.contains('nav-white'))
